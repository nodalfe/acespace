...
export const PRODUCTS = {
  architecture: {
    ...
    items: [
      { type: "베딩룸 텐트 · 1~2인", desc: "아이와 함께하는 수면 공간. TPU 투명 창문으로 하늘을 봅니다." },
      { type: "패밀리 텐트 · 3~4인", desc: "가족이 함께 모이는 넓은 거실형 메인 공간." },
      { type: "리빙쉘 · 6~8인", desc: "가장 넓은 오픈형 공간. 야외 거실을 완성합니다." },
    ],
  },
  living: {
    label: "Living",
    ...
    items: [
      { type: "에어 소파", desc: "공간에 자리를 잡습니다. 분리형 세탁 커버 적용." },
      { type: "에어 베드", desc: "자연 속에서 흘러가듯 잠듭니다. 분리형 세탁 커버 적용." },
      { type: "이불 · 베개 세트", desc: "공간에 온기를 더합니다. OEKO-TEX 인증 소재." },
    ],
  },
} as const;
