...
export const PRODUCTS = {
  architecture: {
    ...
    items: [
      { name: "베라돔 6.0", type: "베딩룸 텐트 · 1~2인", desc: "아이와 함께하는 수면 공간. TPU 투명 창문으로 하늘을 봅니다." },
      { name: "베라돔 4.0", type: "패밀리 텐트 · 3~4인", desc: "가족이 함께 모이는 넓은 거실형 메인 공간." },
      { name: "도킹배드룸", type: "리빙쉘 · 6~8인", desc: "가장 넓은 오픈형 공간. 야외 거실을 완성합니다." },
    ],
  },
  living: {
    label: "Living",
